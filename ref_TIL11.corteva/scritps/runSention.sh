...
# read 1 and read 2 are provided as first and second argument respecitively
...
fasta="/ptmp/LAS/arnstrm/sention/Zea_mays_parviglumis_TIL11-inkind-chr.fasta"
...
RC=1
while [[ $RC -ne 0 ]]; do
rsync -Orts $workdir/ $destination/
RC=$?
sleep 10
done
date
