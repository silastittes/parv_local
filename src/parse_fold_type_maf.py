...
parser.add_argument('-m', '--maf_file', type=str, required = True,
            help='An maf file generated by angsdg. Assumes columns: chromo, position, major, minor, ref, anc, unknownEM, nInd')
